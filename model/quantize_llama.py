...
try:
    from .llama_fast import Transformer
except:
    from llama_fast import Transformer
...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint_path', type=Path, default=Path("/home/lyh/weights/hf/llama2chat/13B/model.pth"), help='Path to the model checkpoint to be quantized.')
