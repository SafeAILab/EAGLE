...
class ModelLpfrog(nn.Module):
    ...
    @torch.no_grad()
    def topK_genrate(self, hidden_states, input_ids, head, logits_processor, lpfrog_layer):
        ...
        if hasattr(self, "stable_kv_lpf") and self.stable_kv_lpf is not None:
            ...
            out_hidden_lpfrog, past_key_values_lpf = lpfrog_layer(hidden_states, input_ids=input_ids[:, kv_len:],
                                               past_key_values=self.stable_kv, use_cache=True)
        else:
